...
function requestAuthorization() {
  ...
  let error = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _utils.logError;
...
async function getCurrentPosition(success) {
  let error = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _utils.logError;
  let options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  (0, _invariant.default)(typeof success === 'function', 'Must provide a valid geo_success callback.'); // Permission checks/requests are done on the native side
